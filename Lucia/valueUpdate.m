function [value_prime, policy] = valueUpdate(params, state, reward, value, value_prime, policy)
...
if reward(state) ~= 0
    ...
    % update values
    aL = aLeft(params, state, coordinate, edge, value);
    aR = aRight(params, state, coordinate, edge, value);
    aS = aStraight(params, state, coordinate, edge, value);
